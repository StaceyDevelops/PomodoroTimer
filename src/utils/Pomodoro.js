...
import ControlPanelBtns from "../ControlPanelBtns/ControlPanelBtns";
import SessionsInfo from "../SessionsInfo/SessionsInfo"
...
function Pomodoro() {
  ...
  const sessions = 1 - session?.timeRemaining / (duration * 60);
      ...
      <div>
        ...
        {session &&
          <div>
            ...
            <SessionsInfo sessions={sessions} />
          </div>
        }
      </div>
    </div>
